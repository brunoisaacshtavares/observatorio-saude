...
namespace observatorio.saude.Migrations
{
    ...
    [Migration("20251007202616_AddIndexToFatoLeitoAnomesCodCnes")]
    partial class AddIndexToFatoLeitoAnomesCodCnes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.CaracteristicaEstabelecimentoModel", b =>
                {
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.EstabelecimentoModel", b =>
                {
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.OrganizacaoModel", b =>
                {
                    b.Property<long>("CodCnes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.ServicoModel", b =>
                {
                    b.Property<long>("CodCnes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.TurnoModel", b =>
                {
                    b.Property<long>("CodTurnoAtendimento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("observatorio.saude.Infra.Models.EstabelecimentoModel", b =>
                {
                    b.HasOne("observatorio.saude.Infra.Models.OrganizacaoModel", "Organizacao")
                        .WithOne("Estabelecimento")
                        .HasForeignKey("observatorio.saude.Infra.Models.EstabelecimentoModel", "CodCnes")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("observatorio.saude.Infra.Models.ServicoModel", "Servico")
                        .WithOne("Estabelecimento")
                        .HasForeignKey("observatorio.saude.Infra.Models.EstabelecimentoModel", "CodCnes")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("observatorio.saude.Infra.Models.TurnoModel", "Turno")
                        .WithMany("Estabelecimento")
                        .HasForeignKey("CodTurnoAtendimento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("observatorio.saude.Infra.Models.CaracteristicaEstabelecimentoModel", "CaracteristicaEstabelecimento")
                        .WithOne("Estabelecimento")
                        .HasForeignKey("observatorio.saude.Infra.Models.EstabelecimentoModel", "CodUnidade");

                    b.HasOne("observatorio.saude.Infra.Models.LocalizacaoModel", "Localizacao")
                        .WithOne("Estabelecimento")
                        .HasForeignKey("observatorio.saude.Infra.Models.EstabelecimentoModel", "CodUnidade");
